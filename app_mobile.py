...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn { width: 100%; padding: 12px; background: #4CAF50; color: white; border: none; border-radius: 8px; font-size: 16px; font-weight: bold; cursor: pointer; margin-top: 15px; box-shadow: 0 8px 18px rgba(76,175,80,0.25); }
        .btn:hover { background: #45a049; }
        .info-panel { position: fixed; top: 20px; right: 20px; width: 360px; background: rgba(255,255,255,0.97); border-radius:12px; box-shadow: 0 12px 32px rgba(15,23,42,0.16); padding: 20px; z-index: 1000; display: none; max-height: 400px; overflow-y: auto; backdrop-filter: blur(6px); }
        .reasoning-panel { position: fixed; bottom: 20px; right: 20px; width: 400px; background: rgba(255,255,255,0.98); border-radius: 12px; box-shadow: 0 12px 32px rgba(15,23,42,0.16); padding: 20px; z-index: 1000; display: none; max-height: 300px; overflow-y: auto; backdrop-filter: blur(6px); }
        ...
        .hotspot-item::after { content: ""; display: block; clear: both; }
        .status { position: fixed; bottom: 20px; left: 50%; transform: translateX(-50%); background: rgba(15,23,42,0.92); color: white; padding: 12px 24px; border-radius: 24px; z-index: 1000; display: none; font-size: 14px; letter-spacing: 0.2px; box-shadow: 0 12px 24px rgba(15,23,42,0.25); }
        ...
        @media (max-width: 480px) {
            ...
            .btn { padding: 11px; }
            .hotspot-item { font-size: 13px; }
            .reasoning-item { font-size: 13px; }
        }
    </style>
</head>
<body>
